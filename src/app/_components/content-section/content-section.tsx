...
export const ContentSection = <T,>({
  ...
  <div className="p-[36px] mt-[60px] border-[1px] border-solid border-charcoal bg-dark-navy rounded-3xl w-[80%]">
    <div className="text-white flex justify-between items-center pb-[20px] border-b-[1px] border-solid border-charcoal">
      <div className="text-[20px]">{renderSearchInput()}</div>
